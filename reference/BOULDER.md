...
| **nonce-service-taro-1**      | 8111       | 9301      | None                                                                                                                                        | `./bin/boulder nonce-service --config test/config/nonce-a.json --addr 10.77.77.77:9301 --debug-addr :8111`   |
| **nonce-service-taro-2**      | 8113       | 9501      | None                                                                                                                                        | `./bin/boulder nonce-service --config test/config/nonce-a.json --addr 10.77.77.77:9501 --debug-addr :8113`   |
| **nonce-service-zinc-1**      | 8112       | 9401      | None                                                                                                                                        | `./bin/boulder nonce-service --config test/config/nonce-b.json --addr 10.77.77.77:9401 --debug-addr :8112`   |
